    ...
    <div>
      ...
      <div className="flex items-center gap-2 mt-2 h-10">
        <div className="flex items-center gap-2 w-full">
          <div className="text-sm font-medium w-24 text-nowrap text-zinc-700 dark:text-zinc-300">
            Vector store
          </div>
          {vectorStore?.id ? (
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <CircleX
                        onClick={() => unlinkStore()}
                        size={16}
                        className="cursor-pointer text-zinc-400 mb-0.5 shrink-0 mt-0.5 hover:text-zinc-700 dark:hover:text-zinc-300 transition-all"
                      />
                    </TooltipTrigger>
            ...
            <div className="flex items-center gap-2">
              <Input
                ...
                className="border border-zinc-300 dark:border-zinc-600 rounded text-sm bg-white dark:bg-gray-800 text-zinc-900 dark:text-zinc-100"
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
