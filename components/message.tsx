    ...
    <div className="text-sm">
      {message.role === "user" ? (
        <div className="flex justify-end">
          <div>
            <div className="ml-2 sm:ml-4 rounded-[16px] px-3 sm:px-4 py-2 md:ml-24 bg-accent dark:bg-accent text-accent-foreground dark:text-accent-foreground font-light">
              <div>
                <div>
                  <ReactMarkdown>
